...
# entity 데이터 로드
data = np.load('/home/JooYeong/mysite/museumbot/entity.npy', allow_pickle=True)
entity_data_modi = pd.DataFrame(data)

# intent 데이터 로드 후 결측치 변환
intent_data = pd.read_csv('/home/JooYeong/mysite/museumbot/intent.csv')
...
# QA 데이터 로드
with open('/home/JooYeong/mysite/museumbot/QA_pair.pickle', 'rb') as handle:
